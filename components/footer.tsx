...
const navigation: {
    ...
    {
        name: "YouTube",
        href: "https://www.youtube.com/c/DavideImolaIT/",
        icon: (props) => (
            <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                <path
        ...
        <footer className="bg-white">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:px-8">
                ...
                <div className="justify-center mt-4 lg:mt-0 flex space-x-3 text-sm ">
                    <a
                        href="https://www.iubenda.com/privacy-policy/20195792"
                    ...
                    <a
                        href="https://www.iubenda.com/privacy-policy/20195792/cookie-policy"
                        className="text-gray-400 hover:text-gray-800"
                        title="Cookie Policy"
                    >
                        Cookie Policy
                    ...
                    <a
                        href="https://www.iubenda.com/terms-and-conditions/20195792"
                        className="text-gray-400 hover:text-gray-800"
