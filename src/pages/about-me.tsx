    ...
    <Layout location={location} title={siteTitle}>
      ...
      >
        ...
        <section itemProp="articleBody">
          ...
          In my spare time, I usually tend to help others as I can. So I have decided to start two different initiatives.

          If you are eager to learn something on the following topics, please reach me with the options you think fit most of your needs.

          <ul>
            <li>Start your career in Computer Science</li>
            <li>Backend Development (JavaScript, TypeScript, Go, JAVA, and Python)</li>
            <li>DevOps</li>
          ...
          <h4>Mentoring</h4>
          I offer free 1-to-1 mentorship time to everyone interested have a guide. I can help you by giving you some advice to continue your journey in Computer Science.
          ...
          <h4>Teaching</h4>
          Instead, if you are looking to learn things in more depth and you require some of my hours, you can buy them from <a href="https://www.docety.com/?referral_code=COADWEZBKJPVTCC21" target="_blank">DOCETY</a>.
          ...
          In case of a lesson, I will contact you before. I want to understand what you want to learn and prepare myself to be ready for you.
